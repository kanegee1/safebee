...
class _ContactsPageState extends State<ContactsPage> {
  ...
  List<Contact> contacts = [
    Contact(name: 'Mom', phoneNumber: '123-456-7890', userId: '001', priority: '3'),
    Contact(name: 'Dad', phoneNumber: '987-654-3210', userId: '002', priority: '1'),
    Contact(name: 'Friend', phoneNumber: '456-789-0123', userId: '003', priority: '2'),
